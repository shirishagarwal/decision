 ...
 * Updated: Fixed "Decision ID missing" bug and added loading states for review submissions.
 */
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <section class="p-10 premium-card bg-indigo-600 text-white border-none shadow-2xl shadow-indigo-100">
                    ...
                    <form id="reviewForm" class="space-y-6">
                        ...
                        <textarea name="outcome" class="w-full p-4 bg-white/10 border border-white/10 rounded-2xl text-white outline-none focus:border-white h-24 placeholder:text-indigo-300/50" placeholder="Actual outcome..."></textarea>
            ...
            <aside class="space-y-8">
                <div class="p-8 premium-card">
                    ...
                    <div class="flex items-center gap-4">
                        <img src="<?php echo $user['avatar_url']; ?>" class="w-12 h-12 rounded-full border-2 border-slate-50">
                        <div>
                ...
                <div class="sticky top-32">
                    <?php
                        // FIX: Explicitly passing the ID to avoid "Decision ID missing" error in simulation
